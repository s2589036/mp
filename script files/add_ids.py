...
with open("all_idioms_for_python.csv", encoding="ANSI") as csv_file:
...
"""
    for line in file.readlines():
        ...
        elements = line.split(",")
        id = elements[0]
        idiom_lemma = elements[8]
        idiom_pos = elements[11]
        print(id, idiom_lemma, idiom_pos)
"""